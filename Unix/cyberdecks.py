...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        # Button images
        button1_image = Image.open("images/new_deck.png")  # Replace with your button image file path
        button1_image = ImageTk.PhotoImage(button1_image)

        button2_image = Image.open("images/edit_deck.png")  # Replace with your button image file path
        button2_image = ImageTk.PhotoImage(button2_image)
        
        button3_image = Image.open("images/load_deck.png")  # Replace with your button image file path
        button3_image = ImageTk.PhotoImage(button3_image)

        # Create buttons and add to the frame with spacing
        button1 = tk.Button(button_frame, image=button1_image, bd=0, highlightthickness=0, command=self.run_editor)
